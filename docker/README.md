...
official/supported Docker Images found at https://hub.docker.com/r/whatcoin/whatcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/whatcoin/whatcoind-develop/ when changing the above text**