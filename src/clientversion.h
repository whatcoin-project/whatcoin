...
#error Client version information missing: version is not defined by whatcoin-config.h or in any other way
#endif
...
/**
 * whatcoind-res.rc includes this file, but it cannot cope with real c++ code.
