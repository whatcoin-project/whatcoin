...
#ifndef WHATCOIN_ARITH_UINT256_H
#define WHATCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Whatcoin only uses this "compact" format for encoding difficulty
...
#endif // WHATCOIN_ARITH_UINT256_H
