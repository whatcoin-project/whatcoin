...
space *do not upload these to the whatcoin.cash server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the whatcoin.cash server

- Update whatcoin.cash

- Announce the release:

  - Release on Whatcoin forum: https://www.whatcoin.cash/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Whatcoin, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~whatcoin.cash/+archive/ubuntu/whatcoin)
