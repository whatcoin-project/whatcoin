...
Below are some notes on how to build Whatcoin Core for Windows.
...
way. This will install to `c:\workspace\whatcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/whatcoin
