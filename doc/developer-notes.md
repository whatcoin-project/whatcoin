...
Whatcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Whatcoin Core, where everyone uses
...
pay attention to for reviewers of Whatcoin Core code.

General Whatcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Whatcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Whatcoin Core so that they can be integrated
