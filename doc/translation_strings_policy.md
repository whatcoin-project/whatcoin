...
This document provides guidelines for internationalization of the Whatcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `whatcoin_en.ts` remains unchanged.
