# Linearize
Construct a linear, no-fork, best version of the Whatcoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install whatcoin_hash

https://github.com/whatcoin-project/whatcoin_hash
...
JSON-RPC server. Running `whatcoind` or `whatcoin-qt -server` will be sufficient.
...
* `input`: whatcoind blocks/ directory containing blkNNNNN.dat
