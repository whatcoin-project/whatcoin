...
from test_framework.test_framework import WhatcoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(WhatcoinTestFramework):
    def set_test_params(self):
        self.set_whatcoin_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as WhatcoinTestFramework doesn't support this atm)
